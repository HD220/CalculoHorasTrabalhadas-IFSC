 ...
 * @author Nicolas
 */
public class WorkNightHour implements IWorkHour{
    ...
    public WorkNightHour(IDescriptionHour description, IHourRevenue hourBaseRevenue, IHour hours){
        this.description = description;
        this.hours = hours;
        this.hourBaseRevenue = hourBaseRevenue;
        this.percent = new Percent(20.0);
