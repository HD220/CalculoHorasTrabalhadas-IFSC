 ...
 * @author Nicolas
 */
public class WorkHolidayHour implements IWorkHour{
    ...
    public WorkHolidayHour(IDescriptionHour description, IHourRevenue hourBaseRevenue, IHour hours){
        this.description = description;
        this.hours = hours;
        this.hourBaseRevenue = hourBaseRevenue;
        this.percent = new Percent(100.0);
